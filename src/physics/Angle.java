...
/**
 * Angle is an immutable abstract data type which represents the mathematical
 * notion of an angle. <code>Angle</code> represents a non-negative angle less
 * than 360 degrees or 2*pi radians.
 **/
public final class Angle implements Serializable, Comparable {
	 ...
	 *                if <code>o</code> is not an Angle

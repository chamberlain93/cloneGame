...
/**
 * Vect is an immutable abstract data type which models the mathematical notion
 * of a vector or a point in 2-space.
 */
public final class Vect implements Serializable {
	 ...
	 * @effects constructs a new unit vector in the direction of
	 *          <code>angle</code>.
	 */
	...
	/**
	 * @return the horizontal coordinate of <code>this</code> in Cartesian
	 *         coordinates
	 */
	public double x() {
		computeXY();
	...
	/**
	 * @return the vertical coordinate of <code>this</code> in Cartesian
	 *         coordinates
	 */
	public double y() {
		computeXY();
	 ...
	 * @return the square of the distance between the points represented by
	 *         <code>this</code> and <code>b</code>
	 */
	...
	/**
	 * @requires <code>b</code> is not null
	 * @return the vector difference of <code>this</code> and <code>b</code>
	 */
	...
	/**
	 * @return a vector that is equivalent to <code>this</code> being rotated by
	 *         pi radians.
	 */
	public Vect neg() {
		if (mode < 0) {
	...
	/**
	 * @return a vector equivalent to <code>this</code> scaled by
	 *         <code>amt</code>.
	 */
	...
	/**
	 * @requires <code>b</code> is not null
	 * @return the dot product of <code>this</code> and <code>b</code>.
	 */
	...
	/**
	 * @return a new <code>Point2D</code> object which is located at the same
	 *         point as <code>this</code>.
	 */

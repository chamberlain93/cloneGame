...
/**
 * This class contains the logic required to perform netwon's method of
...
public class Newton {
	...
	public final static class Result {
		...
		/**
		 * @returns true if this result's derivative's sign is not identical to
		 *          other's
		 **/
	 ...
	 *           for sign changes. If a possible root is found newton's method
	 *           is performed to try to determine the precise value of the root.
	 ...
	 *
	 *           <p>
	 * 			Note: The returned value may not actually be with in these
	 *           bounds.
	 */
	 ...
	 * <code>initial_t</code> and returns the solution. If no solution is found,
	 * returns <code>NaN</code>
	 **/

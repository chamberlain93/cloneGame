...
public class MagnifyEventTest {

	Event event = new MagnifyEvent(); // manually creating a MagnifyEvent
	...
	public void testMagnify() {
		double prevW = testCezmi1.getWidth();
		double prevH = testCezmi1.getHeight();
		event.applyEvent(cezmis); // applying event to cezmis
		assertEquals(prevH * 1.4, testCezmi1.getHeight(), 0.01); // checking
																	// whether
																	// testCezmi1's
																	// height is
																	// equal to
																	// 2*2
		assertEquals(prevW * 1.4, testCezmi1.getWidth(), 0.01); // checking
																// whether
																// testCezmi1's
																// width is
																// equal to 2*2
		// event.finishEvent(); //finishing event
		// assertEquals(1, testCezmi1.getHeight(), 0.01);//checking whether
		// testCezmi1's height is back to normal.
		// assertEquals(2, testCezmi1.getWidth(), 0.01);//checking whether
